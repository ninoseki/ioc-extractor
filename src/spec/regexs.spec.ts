...
describe('hashRegexs', () => {
  it('should match to all md5 values in the input', () => {
  ...
  it('should match to all sha1 values in the input', () => {
  ...
  it('should match to all sha256 values in the input', () => {
  ...
  it('should match to all sha512 values in the input', () => {
  ...
  it('should match to all ssdeep values in the input', () => {
...
describe('networkRegexes', () => {
  ...
  it('should match to all ipv6 values', () => {
...
describe('fileRegexs', () => {
  it('should match to all doc values in the input', () => {
  ...
  it('should match to all exe values in the input', () => {
  ...
  it('should match to all flash values in the input', () => {
  ...
  it('should match to all img values in the input', () => {
  ...
  it('should match to all mac values in the input', () => {
  ...
  it('should match to all web values in the input', () => {
  ...
  it('should match to all zip values in the input', () => {
...
describe('utilityRegexs', () => {
  it('should match to all CVE values in the input', () => {
