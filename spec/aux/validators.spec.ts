...
describe('isSHA256', () => {
  it('checks whether a given value is SHA1 or not', () => {
    expect(isSHA256('9002a1d301adf6e0426af36a40c3c1b33db7891f3f7d93f1cf6e73fdbce0da1b')).toBe(true)
  })
})
...
describe('isSSDEEP', () => {
  it('checks whether a given value is SSDEEP or not', () => {
    expect(isSSDEEP('1536:gQA4ws6RTPdn1Jl19DzTIKu6VnGUNs+9Kf8r3Vf/WcnfYhLrJBew:uiEo/')).toBe(true)
  })
})
